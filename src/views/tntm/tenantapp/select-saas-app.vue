...
<script>
    ...
    import {getSaasApps, addSaasApps} from '@/api/tntm/tenantapp'
    import {tableOption} from './select-saas-app'
        ...
        methods: {
			...
			selectionChange(list){
                ...
                for(var i=0;i<len;i++){
                    ...
                    this.appIds = this.appIds + list[i].id;
